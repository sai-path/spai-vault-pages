...
By downloading, installing, accessing, or using the App, you agree to be bound by these Terms and by our [Privacy Policy](PRIVACY_POLICY.md), which is incorporated by reference. If you do not agree, do not use the App and uninstall it if already installed.

---

## 2. Definitions

- **"App"** means the SPAI Vault iOS application and any updates or replacements we make available.
- **"Terms"** means these Terms of Use, as updated from time to time.
- **"Apple"** means Apple Inc. and its affiliates.
- **"App Store"** means Apple’s App Store through which you may have obtained the App.
- **"Content"** means any data, documents, images, or other materials you add to the App.
...
- Store and organize digital copies of documents (e.g., passports, driver’s licenses, identity documents) on your device.
- Protect access using device security and optional biometric authentication (Face ID or Touch ID).
- Use on-device encryption to help secure stored data.
- Set local notifications for document expiry reminders.
- Optionally support development through in-app tips (purchases processed by Apple).
...
- Use the App to store, share, or promote illegal, harmful, threatening, abusive, or offensive content, or content that infringes or violates the rights of others.
- Attempt to reverse-engineer, decompile, disassemble, or extract the App’s source code (except to the extent expressly permitted by applicable law that cannot be waived by contract).
- Circumvent, disable, or interfere with security, encryption, or access-control features of the App.
- Use the App in any way that could damage, disable, or impair the App or any network or system, or that could harm other users or third parties.
- Use automated means (e.g., bots, scripts) to access or use the App except as we expressly permit.
- Use the App in violation of any applicable law, regulation, or third-party rights.
...
## 7. Your Content and Data; Privacy

- **Your responsibility:** You are solely responsible for the Content you add to the App. You represent and warrant that you have all rights necessary to store and use that Content (e.g., your own documents or those you are authorized to hold) and that your use does not violate any law or third-party rights.
- **Privacy:** Our collection and use of information are described in our [Privacy Policy](PRIVACY_POLICY.md). By using the App, you consent to the practices described there.
- **Backups and security:** You are responsible for securing your device (e.g., passcode, biometrics) and for any backups (e.g., iCloud). We are not responsible for loss, corruption, or unauthorized access to your data due to lost or stolen devices, your backup settings, or your failure to secure your device.
...
- Immigration, travel, or identity-verification advice.
- Any guarantee that stored copies will be accepted by any authority, bank, or other third party.
...
## 12. In-App Purchases and Refunds

- **Optional purchases:** The App may offer optional in-app purchases (e.g., tips to support development). All such purchases are processed by Apple and are subject to Apple’s [Media Services Terms](https://www.apple.com/legal/internet-services/itunes/) and payment policies. You must comply with those terms.
- **Refunds:** Refund requests for in-app purchases must be directed to Apple (e.g., via "Report a Problem" in the App Store). We do not process payments or refunds. We are not responsible for Apple’s decisions regarding refunds.
...
- **Third-party beneficiary:** Apple and its subsidiaries are third-party beneficiaries of these Terms. Upon your acceptance of these Terms, Apple will have the right (and will be deemed to have accepted the right) to enforce these Terms against you as a third-party beneficiary with respect to the license grant and related obligations.
- **Scope of license:** The license in Section 4 is limited to a non-transferable license to use the App on an Apple-branded device that you own or control, as permitted by the App Store Terms of Use.
- **Maintenance and support:** We are solely responsible for any maintenance or support. Apple has no obligation to provide maintenance or support for the App.
- **Warranty:** As between you and Apple, we are solely responsible for any product warranties. To the extent applicable, Apple has no warranty obligation.
- **Claims:** We, not Apple, are responsible for addressing any claims by you or a third party relating to the App or your possession or use of the App (including product liability, failure to conform to legal or regulatory requirements, and consumer protection claims).
- **Compliance:** Where required by the App Store, you represent that you are not located in a country that is subject to a U.S. Government embargo or designated as a "terrorist supporting" country, and that you are not on any list of prohibited or restricted parties. Where the App is available in your region, you agree to comply with all applicable local laws.

---

## 16. Export and Local Compliance
...
- **App:** We may update, modify, or discontinue the App or any feature at any time. We are not obligated to provide updates or to maintain the App indefinitely. Some updates may be required to continue use.
- **Terms:** We may change these Terms from time to time. We will update the "Last updated" and "Effective date" at the top and may provide additional notice for material changes (e.g., in the App or on our website). Your continued use of the App after the effective date of changes constitutes your acceptance of the updated Terms. If you do not agree, you must stop using the App and uninstall it.
...
## 19. Governing Law and Disputes (Worldwide)
...
- **Entire agreement:** These Terms, together with the Privacy Policy and any other policy we reference that is posted in the App or on our website, constitute the entire agreement between you and us regarding the App and supersede any prior agreements.
...
- **Waiver:** Our failure to enforce any right or provision of these Terms will not constitute a waiver of such right or provision. Any waiver must be in writing and signed by us.
- **Assignment:** You may not assign or transfer these Terms or your rights under them without our prior written consent. We may assign these Terms or our rights without restriction.
- **Force majeure:** We are not liable for any failure or delay in performing our obligations where such failure or delay results from circumstances beyond our reasonable control (e.g., acts of God, war, terrorism, pandemic, government action, or failure of third-party services).
- **Headings:** Section headings are for convenience only and do not affect interpretation.
- **International use:** The App is available worldwide. If you access or use the App from outside the United States, you do so at your own risk and are responsible for compliance with the laws of your country or region. Nothing in these Terms excludes or limits any mandatory consumer or statutory rights you have under the laws of your country of residence.
- **Contact and notices:** For questions about these Terms, contact us through the support or contact channel provided in the App or on the SPAI Vault official website or project page. We may provide notices to you via the App, our website, or (if available) email. You are responsible for keeping your contact information current if you have an account or have provided it to us.
