...
- **Keychain:** Encryption keys for your vault are stored in the iOS Keychain with access restricted to when the Device is unlocked (e.g., `kSecAttrAccessibleWhenUnlockedThisDeviceOnly`), in line with Apple’s security guidelines.
